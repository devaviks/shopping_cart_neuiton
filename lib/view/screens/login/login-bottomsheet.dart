  ...
  void _validateAndLogin(BuildContext ctx) {
    ...
    http
      ...
      if (response.statusCode == 200) {
        ...
        if (loginSuccessful) {
          Navigator.of(context).pushNamed(OtpBottomSheet.routeName, arguments: _mobileNumber);
        } else {
          final errorMessage =
  ...
  void _showOTPBottomSheet(BuildContext context) {
    showModalBottomSheet(
      ...
      builder: (BuildContext context) {
        return Container(
          height: 550, // Set the desired height of the bottom sheet
          child: Column(
            children: [
              Container(
