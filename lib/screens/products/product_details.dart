              ...
              child: Row(
                ...
                children: [
                  Container(
                    ...
                    child: ButtonTheme(
                      child: PrimaryButton(
                        key: Key('add_to_bag_button'), // Provide a unique key value
                        title: 'ADD TO BAG',
                        onPressed: () {
                          // Perform the desired action here when the button is pressed
                          // For example, you can add the item to the shopping cart
                        },
                      ),
                    ),
                  ),
